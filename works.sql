...
CREATE TABLE IF NOT EXISTS `experience` (
  ...
  `can_id` bigint(20) NOT NULL,
  PRIMARY KEY (`exp_id`),
  KEY `FK_exp_can` (`can_id`),
  CONSTRAINT `FK_exp_can` FOREIGN KEY (`can_id`) REFERENCES `candidate` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE IF NOT EXISTS `job_skill` (
  ...
  CONSTRAINT `FK9ix4wg520ii2gu2felxdhdup6` FOREIGN KEY (`job_id`) REFERENCES `job` (`job_id`) ON DELETE CASCADE,
